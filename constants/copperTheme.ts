...
/** CTA-Buttons: wie COPPER_PANEL_ACTIVE (Gehaltsrechner Multiplikator aktiv). `!` überschreibt Button-Primary. */
export const COPPER_BUTTON =
  '!border !border-orange-400/70 !bg-[#0a0a0c] !bg-gradient-to-b !from-orange-500/45 !to-orange-600/25 !text-white !shadow-[0_0_32px_-2px_rgba(234,88,12,0.65)] !ring-2 !ring-orange-300/50 hover:!from-orange-500/55 hover:!to-orange-600/35 hover:!shadow-[0_0_38px_-2px_rgba(234,88,12,0.72)] active:!scale-[0.99]';
