/** Kupfer-/Orange-Oberfläche (Kalkulator, Kandidat hinzufügen, …) */
...
/** Akzentfarbe „Talents“ / Hero-Zeile (wie Kalkulator) */
...
/**
 * Hero-CTAs: Fläche wie COPPER_PANEL_ACTIVE (Kalkulator), aber ohne äußeren Orange-Glow/Ring („LED“).
